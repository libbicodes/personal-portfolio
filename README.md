...
Plain HTML, CSS and JavaScript — no build step, no dependencies. Fonts (Pixelify Sans, VT323) and all assets are inlined directly into `index.html`, so the file runs standalone in any browser.
